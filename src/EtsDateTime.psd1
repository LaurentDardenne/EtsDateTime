...
@{
  ...
  Author="Laurent Dardenne. FluentDateTime authors :Slobodan Pavkov, Tom Pester, Simon Cropp. Nager.Date author : Tino Hager.  DateTimeExtensions : Joao Matos Silva"
 ...
 FunctionsToExport=@( 'Get-PublicHolidayFR' )
}
